...
ax.set_title("ROC Curve -- Random Forest (patient split)")
ax.legend(loc="lower right")
plt.tight_layout()
plt.savefig(os.path.join(RESULTS_DIR, "rf_roc.png"), dpi=150, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(RESULTS_DIR, "rf_cm.png"), dpi=150, bbox_inches="tight")
plt.close()
